        ...
        return (
          <div key={step.key} className={styles.stepGroup}>
            <div className={styles.step}>
              ...
              <span
                className={`${styles.label} ${reached ? styles.labelActive : ""}`}
              >
                {step.label}
              </span>
            </div>
            {!isLast && (
              <div
                className={`${styles.connector} ${reached && currentIndex > i ? styles.connectorFilled : ""}`}
              />
            )}
          </div>
        );
        ...
        <div className={styles.stepGroup}>
          ...
          <div className={styles.step}>
            <div
              ...
              style={{ backgroundColor: "var(--lilac-dream)" }}
            >
              ↩
            </div>
            <span className={`${styles.label} ${styles.labelActive}`}>
              Refunded
            </span>
          </div>
        </div>
